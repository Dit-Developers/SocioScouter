...
function check_new_version(){
    ...
    function check_version_on_git(){
        $.get("https://raw.githubusercontent.com/Dit-Developers/SocioScouter/main/Settings.json",function(data){
            new_version = JSON.parse(data)
                if(last_version < new_version.version){
                    show_notif("New version available :)","https://github.com/Dit-Developers/SocioScouter",true)
                }
        })
    }
